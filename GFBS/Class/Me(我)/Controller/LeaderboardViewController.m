...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = ZBLocalized(@"Competitive Insights", nil);
    //[self loadNeweData];
...
-(void)setUpDisplayView
{
    ...
    scrollView.frame = CGRectMake(0, 35, self.view.gf_width, self.view.gf_height - GFNavMaxY - GFTabBarH - 35);
...
-(void)setUpTitleView
{
    ...
    NSArray *titleContens = @[ZBLocalized(@"Cuisine", nil), ZBLocalized(@"Location", nil) ];
