...
#import "ZRBookingHistoryTableViewController.h"
#import "NotificationViewController.h"

#import "GFTitleButton.h"
#import "UIBarButtonItem+Badge.h"

@interface ZRBookingViewController () <UIScrollViewDelegate>
...
@implementation ZRBookingViewController
...
-(void)setUpNavBar
{
    ...
    self.navigationItem.title = ZBLocalized(@"Booking", nil);
...
-(void)setUpTitleView
{
    ...
    NSArray *titleContens = @[ZBLocalized(@"Pending", nil), ZBLocalized(@"History", nil)];
...
{
    //Pending
    ZRBookingPendingTableViewController *pendingVC = [[ZRBookingPendingTableViewController alloc] init];
    NSLog(@"self.view.gf_width in leaderboard is %f", self.view.gf_width);
    [self addChildViewController:pendingVC];
    
    //History
    ZRBookingHistoryTableViewController *historyVC = [[ZRBookingHistoryTableViewController alloc] init];
