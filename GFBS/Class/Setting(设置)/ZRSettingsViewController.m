...
//#import "ZRSettingsSettingsTableViewController.h"

#import "GFTitleButton.h"
#import "UIBarButtonItem+Badge.h"

@interface ZRSettingsViewController () <UIScrollViewDelegate>
...
-(void)setUpNavBar
{
    ...
    self.navigationItem.title = ZBLocalized(@"Profile & Settings", nil);
...
-(void)setUpTitleView
{
    ...
    NSArray *titleContens = @[ZBLocalized(@"Profile", nil), ZBLocalized(@"Settings", nil)];
...
{
    //Profile
    ZRSettingProfileTableViewController *profileVC = [[ZRSettingProfileTableViewController alloc] init];
