...
- (void)setFrame:(CGRect)frame {
    ...
    switch (self.type) {
        ...
        case ImageType:
            /**set imageView*/
            self.imageView.frame = CGRectMake(10, 0.0, frame.size.width - 20, frame.size.height - 60);
            self.imageView.contentMode = UIViewContentModeScaleAspectFit;
            
            /**set descriptionLabel*/
            self.textLabel.frame = CGRectMake(10, frame.size.height - 40, frame.size.width - 20, 40);
            ...
            /**set rankLabel*/
            self.timeLabel.frame = CGRectMake(10.0, frame.size.height - 50, frame.size.width - 20, 20);
            self.timeLabel.textAlignment = NSTextAlignmentCenter;
            self.timeLabel.textColor = [UIColor darkGrayColor];
            [self.timeLabel setFont:[UIFont boldSystemFontOfSize:14]];
            break;
